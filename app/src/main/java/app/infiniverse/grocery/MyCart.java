                ...
                try {
                    ...
                    if (productArray.length() != 0) {
                        ...
                        for (int i = 0; i < productArray.length(); i++) {
                            ...
                            product_prices[i] = " tk " + json_data.getString("mrp") + " ";
                            product_brands[i] = json_data.getString("brand");
                            product_sps[i] = " tk " + json_data.getString("selling_price") + " ";
                        ...
                        tvSavings.setText("tk" + Double.toString(savings));
                        tvPayableAmt.setText("tk" + Double.toString(payable_amt));
