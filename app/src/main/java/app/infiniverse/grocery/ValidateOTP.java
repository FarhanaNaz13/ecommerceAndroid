...
public class ValidateOTP extends AppCompatActivity {
    ...
    EditText etOtp;
    Button btnvalidate;
    String eotp,name,email,mobile,address,password,otp;
    @Override
            ...
            public void onClick(View v) {
                ...
                if(otp.equals(eotp)){
                    try {
                        ...
                        smsManager.sendTextMessage(mobile, null, "OTP to is : "+otp+" to register with ecommerce Store", null, null);

                        RegisterUser registerObj = new RegisterUser();
                        registerObj.execute(name, email, mobile,  address, String.valueOf(otp),password);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                String post_Data = URLEncoder.encode("name", "UTF-8") + "=" + URLEncoder.encode(params[0], "UTF-8") + "&" +
                        ...
                        URLEncoder.encode("otp", "UTF-8") + "=" + URLEncoder.encode(params[4], "UTF-8") + "&" +
